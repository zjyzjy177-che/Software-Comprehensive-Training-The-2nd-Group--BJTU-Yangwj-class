...
python main.py --tick 500 --vis   # CLI with visualization
```

## Requirements

- Python 3.10+
- openpyxl · python-docx · matplotlib
...
Python 3.10+ · Tkinter · Matplotlib · PyInstaller · openpyxl · python-docx
...
| 文档 | 负责人 | 状态 |
|------|--------|------|
| 系统部署环境搭建说明 | 张建宇（A） | ✅ 已完成 |
| 系统使用手册 | 魏嘉昕（C） | ✅ 已完成 |
| 系统设计开发总结报告 | 三人→张建宇汇总 | ✅ 已完成 |
...
### ✅ 新增完成（2026/06/08 — 课程结课 + GitHub开源）
- [x] 所有文档和报告完成
- [x] 项目开源 (MIT License)
- [x] README 合并英文简介 + 中文文档
...
**项目状态**：全部功能完成，98 项测试通过，PyInstaller 打包验证通过（macOS .app + Windows .exe）。弹幕通知、食堂营业时段、导出报告、自动保存均已实现。✅ **所有阶段已完成，课程顺利结课。**
